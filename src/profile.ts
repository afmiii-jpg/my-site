...
export const profile = {
   ...
   */
  funFacts: [
    "I once won $1000 from a scratch off ticket.",
    "My hobbies include playing sports, watching movies, and playing chess.",
  ],
   ...
   */
  repoUrl: "https://github.com/afmiii-jpg/my-site",
};
